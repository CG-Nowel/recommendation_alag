...
class DoctorController extends Controller
{
    ...
    /**
     * Reschedule one of this doctor's own appointments.
     */
    ...
    /**
     * Cancel one of this doctor's own appointments.
     */
    public function cancelAppointment(string $id): void
    {
        ...
        $reason = $this->input('reason', 'Cancelled by doctor');
        $result = $this->appointmentService->updateStatus($appointmentId, 'CANCELLED', $this->userId(), $reason);
        $result['success'] ? Response::success(null, $result['message']) : Response::error($result['message']);
    }
