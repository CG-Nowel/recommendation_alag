...
$router->group(['middleware' => [AuthMiddleware::class]], function ($router) {
    ...
    $router->group(['middleware' => [SuperadminMiddleware::class]], function ($router) {
        ...
        $router->post('/superadmin/users/{id}/reset-password', [SuperadminController::class, 'resetUserPassword']);
        ...
        $router->post('/superadmin/appointments/{id}/edit', [SuperadminController::class, 'editAppointment']);
        $router->post('/superadmin/appointments/{id}/cancel', [SuperadminController::class, 'cancelAppointment']);
    ...
    $router->group(['middleware' => [DoctorMiddleware::class]], function ($router) {
        ...
        $router->post('/doctor/appointments/{id}/edit', [DoctorController::class, 'editAppointment']);
        $router->post('/doctor/appointments/{id}/cancel', [DoctorController::class, 'cancelAppointment']);
